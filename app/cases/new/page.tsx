    ...
    <div className="max-w-2xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">법원</label>
            <input
              type="text"
              value={form.court}
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              onChange={(e) => set('accepted_at', e.target.value)}
              className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm bg-white"
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={(e) => set('hearing_at', e.target.value)}
              className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm bg-white"
            />
          </div>
        </div>
        ...
        <div>
          ...
          <input
            type="datetime-local"
            value={form.next_consultation_at}
            onChange={(e) => set('next_consultation_at', e.target.value)}
            className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm bg-white"
          />
        </div>
